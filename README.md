...
| <a name="input_google_api_dns_override"></a> [google\_api\_dns\_override](#input\_google\_api\_dns\_override) | By default we create PSC for all Google APIs at *.p.googleaps.com, this will additionally override the default *.googleapis.com domain as well | `bool` | n/a | yes |
