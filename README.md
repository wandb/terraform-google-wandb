...
| <a name="input_use_new_ingress"></a> [use\_new\_ingress](#input\_use\_new\_ingress) | Boolean indicating if the new ingress should be used (true) or not (false). Default is false. | `bool` | `false` | no |
